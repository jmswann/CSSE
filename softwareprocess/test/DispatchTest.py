...
# 200 correct
    ...
    def test300_060ShouldGiveErrorOnNonNumericLat2(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30dy.y'
        dict['long'] = '95d41.6'
    ...
    def test300_100ShouldGiveErrorOnNonNumericLong2(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30d30.0'
        dict['long'] = '100dy.y'
    ...
    def test300_120ShouldGiveErrorOnOutOfBoundsAltitude2(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30d30.0'
        dict['long'] = '30d30.0'
    ...
    def test300_130ShouldGiveErrorOnNonNumericAltitude1(self):
        ...
        dict['lat'] = '30d30.0'
        dict['long'] = '30d30.0'
        dict['altitude'] = 'xd30.0'
        dict['assumedLat'] = '-53d38.4'
        dict['assumedLong'] = '74d35.3'
        self.assertEquals(dispatch.dispatch(dict)['error'], 'invalid altitude')

    def test300_140ShouldGiveErrorOnNonNumericAltitude2(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30d30.0'
        dict['long'] = '30d30.0'
        dict['altitude'] = '45dy.y'
        dict['assumedLat'] = '-53d38.4'
        dict['assumedLong'] = '74d35.3'
        self.assertEquals(dispatch.dispatch(dict)['error'], 'invalid altitude')

    def test300_150ShouldGiveErrorOnOutOfBoundsAssumedLat1(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30d30.0'
        dict['long'] = '30d30.0'
        dict['altitude'] = '30d30.0'
        dict['assumedLat'] = '-100d30.0'
        dict['assumedLong'] = '74d35.3'
        self.assertEquals(dispatch.dispatch(dict)['error'], 'invalid assumedLat')

    def test300_160ShouldGiveErrorOnOutOfBoundsAssumedLat2(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30d30.0'
        dict['long'] = '30d30.0'
        dict['altitude'] = '30d30.0'
        dict['assumedLat'] = '30d90.0'
        dict['assumedLong'] = '74d35.3'
        self.assertEquals(dispatch.dispatch(dict)['error'], 'invalid assumedLat')

    def test300_170ShouldGiveErrorOnNonNumericAssumedLat1(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30d30.0'
        dict['long'] = '30d30.0'
        dict['altitude'] = '30d30.0'
        dict['assumedLat'] = 'xd30.0'
        dict['assumedLong'] = '74d35.3'
        self.assertEquals(dispatch.dispatch(dict)['error'], 'invalid assumedLat')

    def test300_180ShouldGiveErrorOnNonNumericAssumedLat2(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30d30.0'
        dict['long'] = '30d30.0'
        dict['altitude'] = '30d30.0'
        dict['assumedLat'] = '30dy.y'
        dict['assumedLong'] = '74d35.3'
        self.assertEquals(dispatch.dispatch(dict)['error'], 'invalid assumedLat')

    def test300_190ShouldGiveErrorOnOutOfBoundsAssumedLong1(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30d30.0'
        dict['long'] = '30d30.0'
    ...
    def test300_200ShouldGiveErrorOnOutOfBoundsAssumedLong2(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30d30.0'
        dict['long'] = '30d30.0'
    ...
    def test300_210ShouldGiveErrorOnNonNumericAssumedLong1(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30d30.0'
        dict['long'] = '30d30.0'
        dict['altitude'] = '30d30.0'
        dict['assumedLat'] = '30d30.0'
        dict['assumedLong'] = 'xd30.0'
        self.assertEquals(dispatch.dispatch(dict)['error'], 'invalid assumedLong')

    def test300_220ShouldGiveErrorOnNonNumericAssumedLong2(self):
        dict = {}
        dict['op'] = 'correct'
        dict['lat'] = '30d30.0'
        dict['long'] = '30d30.0'
